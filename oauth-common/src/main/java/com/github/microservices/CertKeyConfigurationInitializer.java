...
class CertKeyConfigurationInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
	private static Logger log = LoggerFactory.getLogger(CertKeyConfigurationInitializer.class);
